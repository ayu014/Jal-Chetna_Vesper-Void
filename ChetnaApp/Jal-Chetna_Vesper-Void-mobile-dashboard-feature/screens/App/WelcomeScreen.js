...
const WelcomeScreen = ({ navigation }) => {
  ...
  // Use data from the logged-in user
  const displayUser = {
    firstName: user?.firstname || 'Executive',
    lastName: user?.lastname || 'Engineer',
    ...
    >
      <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
        ...
        <View style={styles.header}>
          <View style={styles.userInfo}>
            ...
            <View style={styles.userDetails}>
              ...
              <Text style={styles.userDesignation}>{displayUser.designation}</Text>
            </View>
          </View>
        ...
        <View style={styles.welcomeContainer}>
          ...
          <Text style={styles.welcomeUser}>{displayUser.firstName}!</Text>
        </View>
