  ...
  if (loading) {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.infoText}>Finding nearby stations...</Text>
      </View>
    );
  }
        ...
        stations.map((station) => (
          <View key={station.id} style={styles.stationCard}>
            <View style={styles.stationHeader}>
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      station.hgi_status === "Red"
                        ? "#f8d7da"
                        : station.hgi_status === "Yellow"
                        ? "#fff3cd"
                        : "#d4edda",
                  },
                ]}
            ...
            <Text style={styles.stationInfo}>
              ...
              {station.distance.toFixed(1)} km away • {station.district}
            </Text>
            <Text style={styles.stationInfo}>
              <Ionicons name="water" size={14} color={COLORS.secondary} /> Water
              Level: {station.water_level}m
            </Text>
          </View>
        ))
      ) : (
        <Text style={styles.infoText}>No stations found nearby</Text>
      )}
    </View>
  );
};
